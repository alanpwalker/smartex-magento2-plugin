<?php
namespace Smartex\Core\Observer;
use Magento\Framework\Event\ObserverInterface;
class Smartexemail implements ObserverInterface {
	protected $_logger;
	protected $order;
	public function __construct(\Magento\Sales\Model\Order $order, \Smartex\Core\Helper\Data $logger, array $data = []) {
		$this -> _logger = $logger;
	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		...
		if ($paymentMethodCode == 'smartex' && (!$order -> getEmailSent())) {
