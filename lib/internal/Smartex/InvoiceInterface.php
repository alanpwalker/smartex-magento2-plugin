...
interface InvoiceInterface
{
     ...
     * to the associated ethereum address are credited to the invoice.  If an invoice has
    ...
    /**
     * An expired invoice is one where payment was not received and the 5 minute
    ...
    /**
     * default value: set in your https://smartex.io/order­settings, the default value set in
    ...
    /**
     * The amount of ethereum being requested for payment of this invoice (same as the
    ...
    /**
     * An array containing all ethereum addresses linked to the invoice. 
