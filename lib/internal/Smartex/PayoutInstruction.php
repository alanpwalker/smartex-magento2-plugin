...
{
    /**
     * A transaction is unpaid when the payout in ethereum has not yet occured.
     */
    const STATUS_UNPAID = 'unpaid';

    /**
     * A transaction is marked as paid once the payroll is complete and ethereum are
    ...
    /**
     * Set the ethereum address for this instruction.
     * @param $address
     * @return $this
     */
